          ...
          <div className="mb-16 flex flex-col md:flex-row justify-between items-start md:space-x-8">
            ...
            <div className="relative w-full max-w-md mb-6 md:mb-0 md:w-1/2">
              <Image
                ...
                width={717}
                height={1280}
                className="w-full h-auto md:h-full object-cover transition-transform transform hover:scale-105 duration-300 ease-in-out"
              />
            </div>
              ...
              <div className="mt-8">
                <div className="relative overflow-hidden rounded-lg shadow-lg w-full max-w-md mx-auto">
                  <Image
                    ...
                    width={717}
                    height={1280}
                    className="w-full h-auto object-cover transition-transform transform hover:scale-105 duration-300 ease-in-out"
                  />
                </div>
              </div>
            </div>
