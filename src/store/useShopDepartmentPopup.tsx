...
const useShopDepartmentPopup = () => {
    ...
    const handleShopDepartmentPopup = () => {
        setOpenShopDepartmentPopup((prevState) => !prevState);
    };
    ...
    }, [openShopDepartmentPopup]); // Only include `openShopDepartmentPopup` as a dependency for `useCallback`
    ...
    }, [handleClickOutsideShopDepartmentPopup]); // Only depend on `handleClickOutsideShopDepartmentPopup`
